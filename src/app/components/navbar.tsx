...
export default function Navbar() {
  ...
  return (
    <nav className='flex w-full h-14 items-center px-5 justify-between'>
        ...
        <button onClick={()=>{handleNextMonth()}} className='flex bg-secondary text-secondary-content hover:bg-secondary-darken transition-colors duration-700 items-center justify-center w-fit flex-nowrap text-nowrap px-2 h-8 rounded-lg '>Next Month</button>
    </nav>
  )
}
